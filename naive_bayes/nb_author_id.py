...
# $ python3 -m ud120-projects.naive_bayes.nb_author_id
...
def NBAcuracy(features_train, labels_train, features_test, labels_test):
...
print("Accuracy Score:", NBAcuracy(features_train, labels_train, features_test, labels_test))
